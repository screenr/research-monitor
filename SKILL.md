...
6. Store noisy run logs, rejected candidates, and crawl/search traces in local SQLite or another non-repo state adapter.
7. Propose watchlist updates as explicit JSON patches or suggested-update files; do not silently rewrite strategy unless the user asked for autonomous updates.
